...
var UserData = function UserData() {
  ...
  var _useSWR = Object(swr__WEBPACK_IMPORTED_MODULE_5__["default"])("/api/user/".concat(id), fetcher),
      data = _useSWR.data,
      error = _useSWR.error;

  if (error) {
    return __jsx(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_4__["Alert"], {
      status: "error",
      __self: _this,
      __source: {
...
//# sourceMappingURL=[id].js.c82de237bb4969f566bf.hot-update.js.map